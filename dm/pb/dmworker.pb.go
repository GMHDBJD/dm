...
const (
	HandleOp_SkipError       HandleOp = 0
	HandleOp_ReplaceError    HandleOp = 1
	HandleOp_InvalidHandleOp HandleOp = 2
)

var HandleOp_name = map[int32]string{
	0: "SkipError",
	1: "ReplaceError",
	2: "InvalidHandleOp",
}

var HandleOp_value = map[string]int32{
	"SkipError":       0,
	"ReplaceError":    1,
	"InvalidHandleOp": 2,
}

func (x HandleOp) String() string {
	return proto.EnumName(HandleOp_name, int32(x))
}

func (HandleOp) EnumDescriptor() ([]byte, []int) {
...
type HandleWorkerErrorRequest struct {
	Op        HandleOp `protobuf:"varint,1,opt,name=op,proto3,enum=pb.HandleOp" json:"op,omitempty"`
	Task      string   `protobuf:"bytes,2,opt,name=task,proto3" json:"task,omitempty"`
...
func (m *HandleWorkerErrorRequest) GetOp() HandleOp {
	if m != nil {
		return m.Op
	}
	return HandleOp_SkipError
}
...
func init() {
	...
	proto.RegisterEnum("pb.HandleOp", HandleOp_name, HandleOp_value)
...
var fileDescriptor_51a1b9e17fd67b10 = []byte{
	...
	,
}
